...
# # GET upcoming tasks (due today or later)
# @app.route("/tasks/upcoming", methods=["GET"])
# def upcoming_tasks():
#     tasks = fetch_todoist_tasks()
#     upcoming = [t for t in tasks if t.get("due") and datetime.fromisoformat(t["due"]["date"]) >= datetime.now()]
...
# def overdue_tasks():
#     tasks = fetch_todoist_tasks()
#     overdue = [t for t in tasks if t.get("due") and datetime.fromisoformat(t["due"]["date"]) < datetime.now()]
